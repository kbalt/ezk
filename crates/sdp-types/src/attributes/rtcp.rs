...
mod test {
    ...
    #[test]
    fn rtcp() {
        let input = BytesStr::from_static("4444");
    ...
    #[test]
    fn rtcp_address() {
        let input = BytesStr::from_static("4444 IN IP4 192.168.123.222");
    ...
    fn rtcp_address_print() {
        ...
        assert_eq!(rtcp.to_string(), "4444 IN IP4 192.168.123.222");
    }
}
